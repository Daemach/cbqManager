...
# cbqManager - AI Agent Instructions
...
- **cbq** - Use this skill when implementing asynchronous background job processing in ColdB...
- **cbsecurity** - Use this skill when securing ColdBox/BoxLang applications with cbsecurity. Cover...
- **cbvalidation** - Use this skill when validating user input in ColdBox/BoxLang using cbvalidation....
- **mementifier** - Use this skill when serializing ColdBox/BoxLang ORM entities or model objects to...
- **qb** - Use this skill when building database queries with qb (Query Builder) in ColdBox...
- **relax** - Use this skill when modeling REST APIs with the Relax DSL, defining routes with ...
...
- **cbq**: CBQ Job Queues - https://cbq.ortusbooks.com/~gitbook/mcp
